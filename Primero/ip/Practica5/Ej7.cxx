...
void suma(float v1[], float v2[], float v3[], int n){
	for (int i=0; i<n; i++){
		v3[i]=v1[i]+v2[i];//Sumamos el primer termino de v1[] y v2[] y el resultado de la suma lo guardamos en el primer elemento de v3[], y así sucesivamente hasta el último valor
	}
}
int test();
int main(){ 

...
class Ruleta {
    ...
    private:
        ...
        int njugadores_;                    //Numero de jugadores
    ...
    public:
        ...
        bool hayJugadores();                                                    //Funcion que comprueba si la lista de jugadores esta vacia o no

        std::list<Jugador> getJugadores(){return jugadores_;}                   //Funcion que devuelve la lista de jugadores

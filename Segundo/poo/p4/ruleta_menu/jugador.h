...
class Jugador: public Persona {         //Clase Jugador que hereda de la clase Persona
    ...
    public:
        ...
        inline std::string getCodigo() const { return codigo_;}                     //Función observadora del dinero
        inline std::list<Apuesta> getApuestas() const { return apuestas_;}          //Función observadora del dinero

...
class Persona {
    ...
    private:
        ...
        //Variables que contienen en forma de cadenas los valores pedidos en el enunciado
    ...
    public:
        ...
        inline void setDNI(std::string dni){dni_=dni;}                              //Funcion modificadora del DNI
        inline void setNombre(std:: string nombre){nombre_=nombre;}                 //Funcion modificadora del nombre
        inline void setApellidos(std::string apellidos){apellidos_=apellidos;}      //Funcion modificadora del apellidos
        bool setEdad(int const &edad);                                              //Funcion modificadora del edad
        inline void setDireccion(std::string direccion){direccion_=direccion;}      //Funcion modificadora del dirección
        inline void setLocalidad(std::string localidad){localidad_=localidad;}      //Funcion modificadora del localidad
        inline void setProvincia(std::string provincia){provincia_=provincia;}      //Funcion modificadora del provincia
        inline void setPais(std::string pais){pais_=pais;}                          //Funcion modificadora del pais

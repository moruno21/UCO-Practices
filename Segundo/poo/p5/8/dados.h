...
class Dados{
    ...
    private:
        ...
        int ultimos1 [5];  //Aquí almacenaremos de inicio los ultimos 5 valores del dado 1
        int ultimos2 [5];  //Aquí almacenaremos de inicio los ultimos 5 valores del dado 2
